...
@Component({
  selector: 'app-mnista',
  templateUrl: './mnista.component.html',
  styleUrls: ['./mnista.component.css']
})
export class MnistAComponent implements OnInit {
  ...
  async loadPretrainedModel(): Promise<void> {
    ...
    const path = 'assets/tfjs-models/mnista-recognition/model.json';
