...
@Component({
  selector: 'app-mnistb',
  templateUrl: './mnistb.component.html',
  styleUrls: ['./mnistb.component.css']
})
export class MnistBComponent implements OnInit {
  ...
  async loadPretrainedModel(): Promise<void> {
    ...
    const path = 'assets/tfjs-models/mnistb-recognition/model.json';
